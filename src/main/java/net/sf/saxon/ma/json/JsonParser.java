...
public class JsonParser {
     ...
     * @param context   XPath evaluation context
     * @throws XPathException if a dynamic error occurs (for example, invalid JSON input)
     */
     ...
     * @param context   XPath evaluation context
     * @throws XPathException if a dynamic error occurs (such as invalid JSON input)
     */
