...
public class SaxonDuration extends Duration {
     ...
     * <p>Calls {@link Calendar#add(int, int)} in the
     ...
     * <p>Note that because {@link Calendar#add(int, int)} is using
     ...
     *         {@link DatatypeConstants#GREATER}
