...
public abstract class NodeOverNodeInfo implements Node {
     ...
     * @throws DOMException <br> NO_MODIFICATION_ALLOWED_ERR: Always raised.
     */
     ...
     * @throws DOMException if a dynamic error occurs
     */
     ...
     *
     * @throws DOMException always, to indicate that update is not supported in this DOM implementation
     */
