 ...
 * {@link Expression#addToPathMap(PathMap, PathMapNodeSet)} can be
...
public class PathMap {
    ...
    public static class PathMapArc {
         ...
         * Create a PathMapArc
         *
         * @param axis   the axis (a constant from class {@link AxisInfo}
         ...
         *
         * @return the axis, a constant from class {@link AxisInfo}
         */
    ...
    public PathMapRoot getContextDocumentRoot() {
        ...
        PathMapRoot[] roots = getPathMapRoots();
    ...
    /**
     * Supporting method for {@link #reduceToDownwardsAxes(PathMapRoot)}
     *
