...
public class SequenceTool {
     ...
     * @throws XPathException if the supplied Sequence contains multiple items
     */
     ...
     * @throws XPathException if an error occurs: for example, if the XPath value is
     ...
     *                   destination
     * @throws XPathException if an error occurs (for example if the value is
