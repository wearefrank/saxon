...
public abstract class ParentNodeImpl extends NodeImpl {
     ...
     *              {@link NodeImpl}. It will be modified as a result of this call (by setting its
     ...
     *                nodes belonging to any implementation, but elements must be instances of {@link ElementImpl}.
     ...
     *                {@link ElementImpl}; otherwise they will be copied. If the nodes are copied, then on return
