...
public class FeatureData {
    ...
    public static void init() {
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/collation-uri-resolver", 6, "HE PE EE", CollationURIResolver.class, null));

       featureList.add(new FeatureData("http://saxon.sf.net/feature/collation-uri-resolver-class", 7, "HE PE EE", String.class, null));

       featureList.add(new FeatureData("http://saxon.sf.net/feature/collection-finder", 8, "HE PE EE", CollectionFinder.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/environmentVariableResolver", 28, "HE PE EE", EnvironmentVariableResolver.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/moduleURIResolver", 42, "HE PE EE", ModuleURIResolver.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/outputURIResolver", 49, "HE PE EE", OutputURIResolver.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/schemaURIResolver", 58, "EE", SchemaURIResolver.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/traceListener", 79, "HE PE EE", TraceListener.class, null));
       ...
       featureList.add(new FeatureData("http://saxon.sf.net/feature/unparsedTextURIResolver", 85, "HE PE EE", UnparsedTextURIResolver.class, null));
