 ...
 * {@link FeatureKeys#ALLOW_EXTERNAL_FUNCTIONS} is false. In cases where an <code>ExtensionFunctionCall</code>
...
public abstract class ExtensionFunctionCall implements Callable {
     ...
     *         result type. Saxon will check that this is the case if the {@link ExtensionFunctionDefinition#trustResultType()}
