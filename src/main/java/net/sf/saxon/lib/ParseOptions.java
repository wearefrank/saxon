...
public class ParseOptions {
    ...
    public void merge(/*@NotNull*/ ParseOptions options) {
        ...
        validationErrorLimit = Math.min(validationErrorLimit, options.validationErrorLimit);
    }
     ...
     *
     * @param model typically {@link Builder#TINY_TREE},
     *              {@link Builder#LINKED_TREE} or {@link Builder#TINY_TREE_CONDENSED}
     */
     ...
     *
     * @return typically {@link Builder#TINY_TREE}, {@link Builder#LINKED_TREE},
     * or {@link Builder#TINY_TREE_CONDENSED},
     ...
     * Get the tree model that will be used.
     *
     * @return typically one of the constants {@link TreeModel#TINY_TREE},
     * {@link TreeModel#TINY_TREE_CONDENSED}, or {@link TreeModel#LINKED_TREE}. However, in principle
     * a user-defined tree model can be used.
     */
