 ...
 * use the factory method {@link Processor#newDocumentBuilder()}.</p>
...
public class DocumentBuilder {
     ...
     * Configuration).
     *
     * @param model typically one of the constants {@link TreeModel#TINY_TREE},
     ...
     * Configuration).
     *
     * @return the tree model in use: typically one of the constants {@link TreeModel#TINY_TREE},
     ...
     * Java methods {@link NodeInfo#getLineNumber()} and
     * {@link NodeInfo#getColumnNumber()}</p>
     ...
     *               a {@link StreamSource} or a {@link javax.xml.transform.sax.SAXSource}.
     ...
     *               <p>If the source is an instance of {@link NodeInfo} then the subtree rooted at this node
     ...
     * <p>If the supplied object implements the {@link NodeInfo} interface then it
     * will be wrapped as an <code>XdmNode</code> without copying and without change. The <code>NodeInfo</code>
     * must have been created using a {@link Configuration} compatible
     ...
     *             {@link NodeInfo}, or an instances of a node in an external object model.
