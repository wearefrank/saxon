...
public class Xslt30Transformer extends AbstractXsltTransformer {
     ...
     * and any template parameters set using {@link #setInitialTemplateParameters(Map, boolean)}.
     *
     ...
     * It also uses any template parameters set using {@link #setInitialTemplateParameters(Map, boolean)}.
     *
     ...
     * destination. If {@link #setInitialTemplateParameters(Map, boolean)} has been
