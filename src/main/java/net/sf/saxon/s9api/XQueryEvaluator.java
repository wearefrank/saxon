 ...
 * method of an {@link XQueryExecutable}.</p>
...
public class XQueryEvaluator extends AbstractDestination implements Iterable<XdmItem> {
     ...
     * <p>If the source is an instance of {@link NodeInfo}, the supplied node is used
     * directly as the context node of the query.</p>
     * <p>If the source is an instance of {@link DOMSource}, the DOM node identified
     ...
     * {@link DocumentBuilder#build(Source)}, and the document
...
//                destination.close();
     ...
     * context node set on that <code>XQueryEvaluator</code> (using {@link #setSource(Source)}) is ignored.</p>
     *
