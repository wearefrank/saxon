...
public class XdmValue implements Iterable<XdmItem> {
     ...
     * <li>An instance of {@link Sequence} (for example, a
     * {@link NodeInfo} or {@link AtomicValue}),
     * which is wrapped as an {@code XdmValue}</li>
     * <li>An instance of {@link Map}, which is converted to an XDM Map using
     ...
     * <li>A Java collection, more specifically {@link Iterable}, which is converted to an XDM sequence
