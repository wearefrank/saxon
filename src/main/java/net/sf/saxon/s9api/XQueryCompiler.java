...
public class XQueryCompiler {
     ...
     * <p>The base URI of the query should be supplied by calling {@link #setBaseURI(URI)} </p>
     ...
     *              base URI of the query, overriding any URI supplied using {@link #setBaseURI(URI)} (but not
    ...
    /**
     * Get the underlying {@link StaticQueryContext} object that maintains the static context
