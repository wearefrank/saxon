...
public class DynamicQueryContext {
     ...
     *         or the default mode {@link Validation#DEFAULT} otherwise.
     */
     ...
     * {@link Configuration#buildDocumentTree} in the Configuration class.
     *
    ...
    /**
     * Get the date and time set previously using {@link #setCurrentDateTime(DateTimeValue)}
