...
public class PrincipalStylesheetModule extends StylesheetModule implements GlobalVariableManager {
     ...
     *
     * @throws XPathException if errors are found in the stylesheet
     */
...
//        }
     ...
     *
     * @throws XPathException if errors are detected
     */
     ...
     *
     * @throws XPathException if static errors are found in the stylesheet
     */
